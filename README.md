...
- **2026-09-18 élő teszt: `/cmd_vel` és `/arm_cmd` megerősítve, szoftverlánc (soros port, STM32, IMU/odom 20Hz) egészséges.** Ha mégsem mozog a bázis — se webről, se fizikai joystickről —, az hardveres ok (E-stop gomb, külön motor-tápkapcsoló, alacsony akkufeszültség), nem szoftverhiba. Lásd [docs/08-kezi-vezerles.md](docs/08-kezi-vezerles.md) diagnosztika szakaszát. **2026-09-23:** a gyári forrásból igazolt gripperskála `0 = nyitva`, `100 = zárva`; a felhasználó kérésére a kis lépéses gombos panel külön kar-élesítés után élő `/arm_cmd` parancsot küld. A vezérlő kezelői felügyelet mellett használandó, mert nincs mért karpozíció.
